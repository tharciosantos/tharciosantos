<div align="center">
  ...
  <p>
    ...
    Hoje construo produtos completos: interface, API, banco relacional e controle de acesso (RBAC/RLS), com regra de negócio coberta por teste — não só pela tela.
  </p>
  ...
  <p><em>Buscando estágio ou júnior em Caeté / Belo Horizonte e região (MG).<br/>Presencial, híbrido ou remoto.</em></p>
</div>
...
Sistema full stack para equipamentos, ordens de serviço e SLAs. Sai da planilha e entrega visibilidade real do que está parado, em andamento ou atrasado.
...
- Frontend em React + Vite com cache e sincronização via TanStack Query + testes E2E com Cypress
...
- Moro em Caeté, região metropolitana de Belo Horizonte (MG)
